# PROJETO-CADASTRO
- Projeto criado em sala de aula para cadastro de alunos

## 📝Finalidade
- Site com informações sobre os alunos para controle dos mesmos


## 👨‍💻Funcionalidade
- [x] Projeto feito com HTML, CSS, JavaScript e SQL.

- [x] SQL foi utilizado para armazenar as informações de cada aluno

- [x] Possibilita cadastro e login de alunos e professores

## Prints

### 🖥️Tela Cadastro
![Tela Cadastro](./prints/cadusuario.png)

### 🎓Tela Lista de Alunos
![Tela Lista de ALunos](./prints/lista.png)

### 👤Tela Login
![Tela Login](./prints/login.png)

### 👨‍🎓Tela Coleta de Dados
![Tela Coleta de Dados](./prints/dados.png)
...
5. [SQL- Structured Query Language](https://pt.wikipedia.org/wiki/SQL)<br>

6. [Bootstrap](https://getbootstrap.com/)<br>

## 🔗Link para acessar o projeto no GitHub


* [Clique aqui para ir ao repositório do projeto](https://github.com/pedrobezerra14/final-version-student-registration)